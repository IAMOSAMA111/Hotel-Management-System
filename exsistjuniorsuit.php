...
<body background="hotel2.jpg"  id="b1">
	...
	<tr>
		...
		<tr>
			<td class="label">Receptionist Password  </td>
			<td><input  id ="idbox" type="password" name="receppass" value="" required><br><br></td>
		</tr>
		<tr>
